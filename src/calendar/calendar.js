...
var Calendar = (function () {
    ...
    Calendar.prototype.convertMonth = function(month) {
        var newMonth = ['January', 'February', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'October', 'November', 'December'];
        return newMonth[month - 1];
    };
    // 选择某日期，点击事件
